...
public class ListCommands {
    ...
    public ListCommands(JedisPooled jedis) {
        this.jedis = jedis;
    }
     ...
     */
    public Long pos(String key, String element) {
     ...
     */
    public Long pos(String key, String element, LPosParams params) {
     ...
     */
    public List<Long> pos(String key, String element, LPosParams params, long count) {
     ...
     */
    public long insert(String key, ListPosition where, String pivot, String value) {
        return jedis.linsert(key, where, pivot, value);
    }

    /**
     * Inserts specified values at the head of the list stored at key. In contrary to
     * {@link redis.clients.jedis.commands.ListCommands#lpush(String, String...) LPUSH}, no operation will be performed when key
     * does not yet exist.
     * @param key
     ...
     * {@link redis.clients.jedis.commands.ListCommands#rpush(String, String...) RPUSH}, no operation will be performed when key
     * does not yet exist.
     * @param key
     * @param strings the strings to push
     * @return The length of the list after the push operation
    ...
    /**
     * The blocking version of {@link redis.clients.jedis.commands.ListCommands#lpop(String)} LPOP} because it blocks the connection
    ...
    /**
     * @see redis.clients.jedis.commands.ListCommands#blpop(int, String...)
     */
    ...
    /**
     * @see redis.clients.jedis.commands.ListCommands#blpop(double, String...)
     */
    ...
    /**
     * The blocking version of {@link redis.clients.jedis.commands.ListCommands#rpop(String)} RPOP} because it blocks the connection
    ...
    /**
     * @see redis.clients.jedis.commands.ListCommands#brpop(int, String...)
     */
    ...
    /**
     * @see redis.clients.jedis.commands.ListCommands#brpop(double, String...)
     */
    ...
    /**
     * The blocking variant of {@link redis.clients.jedis.commands.ListCommands#rpoplpush(String, String)}. When source is
     ...
     */
    public String move(String srcKey, String dstKey, ListDirection from, ListDirection to) {
     ...
     * @return The element being popped and pushed
     */
    public String bmove(String srcKey, String dstKey, ListDirection from, ListDirection to, double timeout) {
